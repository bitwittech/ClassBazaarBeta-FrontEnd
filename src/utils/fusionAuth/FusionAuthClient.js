...
FusionAuthClient.prototype = {
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  exchangeOAuthCodeForAccessToken: function(
    code,
    client_id,
    client_secret,
    redirect_uri,
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  exchangeRefreshTokenForAccessToken: function(
    refresh_token,
    client_id,
    client_secret,
    scope,
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  exchangeUserCredentialsForAccessToken: function(
    username,
    password,
    client_id,
    client_secret,
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  retrieveUserLoginReport: function(
    applicationId,
    userId,
    start,
    end,
   ...
   * @param {Function} callBack The response handler call back. This function will be passed the ClientResponse object.
   */
  retrieveUserLoginReportByLoginId: function(
    applicationId,
    loginId,
    start,
    end,
